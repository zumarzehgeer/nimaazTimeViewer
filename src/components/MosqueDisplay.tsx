  ...
  return (
    <div className='flex flex-col bg-[#FFEDD8]'>
      ...
      <div className='flex flex-col lg:flex-row'>
        ...
        <div className='w-full lg:w-[55%] flex flex-col px-[clamp(1rem,2vw,3rem)] py-[clamp(1rem,2vw,2rem)]'>
          ...
          <div className='flex justify-between gap-4 items-center'>
            ...
            <div>
              ...
              {method && (
                <p className='text-[clamp(0.65rem,0.9vw,0.9rem)] text-[#3c3c3c]/40 mt-2 font-medium tracking-wide'>
                  {method}
                </p>
              )}
            </div>
